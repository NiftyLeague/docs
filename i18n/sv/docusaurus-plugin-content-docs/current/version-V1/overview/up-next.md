...
Tillsammans med ytterligare spel har vi flera idéer på gång för att fortsätta att växa vår plattform. One of our main goals is to launch a marketplace allowing you to collect reusable NFTs such as cars, special weapons, or wearables for our games. Dessa smarta kontrakt skulle utöka ERC-1155 Ethereum multi-token-standarden för att skapa icke-fungibla föremål med en fastställd gräns för tillgänglighet för var och en. Som en bonus för att spela våra spel skulle vi vilja ge föremål som kan köpas här till spelare som sedan kan sälja dem eller använda dem i spelet. Ett annat alternativ vi överväger är att tilldela tidsutgivna NFT:er som skattkistor som kan brännas och avslöjar samlarobjektet inuti.
