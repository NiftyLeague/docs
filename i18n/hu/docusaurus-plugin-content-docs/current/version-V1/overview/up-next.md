...
A további játékok mellett számos ötletünk van a platformunk továbbfejlesztéséhez. One of our main goals is to launch a marketplace allowing you to collect reusable NFTs such as cars, special weapons, or wearables for our games. Ezek az intelligens szerződések kibővítenék az ERC-1155 Ethereum több token szabványt, hogy nem helyettesíthető elemeket hozzanak létre, mindegyikhez meghatározott elérhetőségi korláttal. A játékaink bónuszaként az itt megvásárolható tárgyakat szeretnénk odaítélni azoknak a játékosoknak, akik eladhatják vagy felhasználhatják a játékban. Egy másik lehetőség, amit fontolgatunk, az időzített NFT-k díjazása, mint például a kincsesládák, amelyek elégethetők, felfedve a benne lévő gyűjteményt.
