...
Pregătește-te de ceartă! The local-multiplayer version of **[Nifty Smashers](https://nifty-league.com/games)** was made available immediately at launch followed by the online multiplayer.
...
- Un lobby personalizat poate fi folosit pentru a deschide un meci într-o regiune aleasă. The creator of the lobby can see a code in the lobby map which can be shared with others.
...
- Apăsând SA face pisica să se năpustească. After pouncing for a short duration, the cat ges empowered.
