...
احصل على استعداد للشجار! The local-multiplayer version of **[Nifty Smashers](https://nifty-league.com/games)** was made available immediately at launch followed by the online multiplayer.
...
- يمكن استخدام ردهة مخصصة لفتح مباراة في المنطقة المختارة. The creator of the lobby can see a code in the lobby map which can be shared with others.
...
- الضغط على SA يجعل القطة تنقض. After pouncing for a short duration, the cat ges empowered.
