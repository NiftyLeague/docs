...
Maak je klaar om te vechten! The local-multiplayer version of **[Nifty Smashers](https://nifty-league.com/games)** was made available immediately at launch followed by the online multiplayer.
...
- Een aangepaste lobby kan worden gebruikt om een wedstrijd in een gekozen regio te openen. The creator of the lobby can see a code in the lobby map which can be shared with others.
...
- Door op de SA te drukken, springt de kat naar voren. After pouncing for a short duration, the cat ges empowered.
