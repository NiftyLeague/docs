...
乱闘する準備をしなさい！ The local-multiplayer version of **[Nifty Smashers](https://nifty-league.com/games)** was made available immediately at launch followed by the online multiplayer.
...
- カスタムロビーを使用して、選択した地域で試合を開くことができます。 The creator of the lobby can see a code in the lobby map which can be shared with others.
...
- SAを押すと、猫が飛び跳ねます。 After pouncing for a short duration, the cat ges empowered.
