...
Neben zusätzlichen Spielen haben wir einige Ideen auf Lager, um unsere Plattform weiter auszubauen. Eines unserer Hauptziele ist es, einen Marktplatz zu eröffnen, auf dem Sie wiederverwendbare NFTs wie Autos, Spezialwaffen oder Wearables für unsere Spiele sammeln können. Diese intelligenten Verträge würden den Multi-Token-Standard ERC-1155 von Ethereum erweitern, um nicht fungible Gegenstände mit einer festgelegten Verfügbarkeitsgrenze für jeden zu erstellen. Als Bonus für das Spielen unserer Spiele möchten wir hier käufliche Gegenstände an Spieler vergeben, die sie dann verkaufen oder im Spiel verwenden können. Eine weitere Option, die wir in Betracht ziehen, ist die Vergabe von zeitverzögerten NFTs wie Schatztruhen, die verbrannt werden können und das darin enthaltene Sammlerstück enthüllen.
