...
Nifty League DEGEN NFT zostały powołane do życia przez naszą społeczność pod koniec września 2021 roku. Proces wybijania był jedynym w swoim rodzaju spektaklem, który pozwolił minterom zaprojektować własny DEGEN przy użyciu[Mint-O-Matic](https://niftyleague.com/mint-o-matic)firmy Satoshi.

## Premiera alfa Nifty Smashers ✅
...
Biorąc pod uwagę ograniczenia przeglądarki w naszej poprzedniej wersji WebGL, postanowiliśmy skoncentrować nasze natychmiastowe wysiłki na stworzeniu programu uruchamiającego, który zawierałby wszystkie nasze gry i zawierał integracje społecznościowe Discord. Teraz, gdy limity pamięci nie są problemem, możemy swobodnie wprowadzać dodatkowe animacje, zestawy ruchów i inne projekty NFT – a wszystko to znacznie poprawiając ping dla naszych użytkowników.
...
Nasz zespół powoli sugerował nadchodzące narzędzia do komiksów — jak być może już wiesz, będziesz mógł spalić każdą stronę w celu uzyskania specjalnych przedmiotów w grze, które zwiększą mnożnik NFTL twojego DEGEN… ale zabawa się nie kończy !

Wcześniej zrzuciliśmy nasze pierwsze 4 strony komiksów do mincerzy i nadal mamy 2 strony dla posiadaczy DEGEN w lutym 2022 roku. Słowo od Satoshi - zabezpieczenie pełnej kolekcji lub 2 to _wysoce_ zalecane.
...
Współpracujemy z zespołem Immutable X, aby uruchomić nasz rynek przedmiotów na początku 2022 roku. Wśród ofert znajdą się fajne skórki, broń, przedmioty jednorazowego użytku i nie tylko, które poprawią twój DEGENS w grze. Podczas gdy niektóre przedmioty mogą być dodatkami kosmetycznymi, wiele z nich zawiera mnożniki NFTL do gry i zarabiania.
...
W ramach przygotowań do NiftyVerse zaczniemy od udostępnienia czatu w grze, aby porozmawiać lub wysłać SMS-a z DEGEN frens. Będąc popularnym żądaniem - jest szansa, że może to zostać wprowadzone wcześniej w naszej osi czasu - bądź na bieżąco!

## fajny wers

Witamy w NiftyVerse — świecie wypełnionym społecznościami DEGENS i NFT, które mają wspólną wizję dobrej zabawy i budowania kwitnącej społeczności graczy. Tym, co wyróżnia NiftyVerse na tle innych metawersów, jest to, że nasze gry p2e są centralnym elementem. Wejdź do naszego pokoju zręcznościowego wypełnionego zabawnymi minigrami lub udaj się do miejsc na mapie, aby wskoczyć do naszych klasycznych tytułów, takich jak Nifty Smashers i Nifty Kart.
