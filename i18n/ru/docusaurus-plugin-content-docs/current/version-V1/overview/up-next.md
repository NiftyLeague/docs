...
We previously airdropped our initial 4 comic pages to minters and still have 2 pages remaining for DEGEN holders in early 2022. Слово от Сатоши — полная коллекция или 2 — это _настоятельно рекомендуется_
