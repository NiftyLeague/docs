...
Спремите се за тучу! The local-multiplayer version of **[Nifty Smashers](https://nifty-league.com/games)** was made available immediately at launch followed by the online multiplayer.
...
- Прилагођени лоби се може користити за отварање утакмице у изабраном региону. The creator of the lobby can see a code in the lobby map which can be shared with others.
...
- Притиском на СА мачка скочи. After pouncing for a short duration, the cat ges empowered.
