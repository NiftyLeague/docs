...
Bersiaplah untuk berkelahi! The local-multiplayer version of **[Nifty Smashers](https://nifty-league.com/games)** was made available immediately at launch followed by the online multiplayer.
...
- Lobi khusus dapat digunakan untuk membuka pertandingan di wilayah yang dipilih. The creator of the lobby can see a code in the lobby map which can be shared with others.
...
- Menekan SA membuat kucing menerkam. After pouncing for a short duration, the cat ges empowered.
